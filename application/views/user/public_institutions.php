...
<div class="content">
  <h3>Learning Institutions/ Public</h3>
  <hr/>
  <?php
    ...
    $sql = "INSERT INTO learning_institutions (badge_img, school_name, district, county, sub_county, school_level, status, institution, contact) VALUES ('', '$name', '$district', '$county', '$subCounty', '$school_level', 'not subscribed', 'public', '')";
  ...
  <div class="container" style="margin: 10px">
            ...
            <div id="kindergarten" class="tabcontent">
                ...
                <div>
                  <?php
                    ...
                    $sql = "INSERT INTO learning_institutions (badge_img, school_name, district, county, sub_county, school_level, status, institution) VALUES ('$ServerURL', '$name', '$district', '$county', '$subCounty', '$school_level', 'subscribed', 'public')";
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                $sql_fetch = "SELECT * FROM learning_institutions WHERE school_level = 'Kindergarten' AND status = 'subscribed' AND institution = 'public'";
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                $sql_fetch = "SELECT * FROM learning_institutions WHERE school_level = 'primary' AND status = 'subscribed' AND institution = 'public'";
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                $sql_fetch = "SELECT * FROM learning_institutions WHERE school_level = 'secondary' AND status = 'subscribed' AND institution = 'public'";
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                $sql_fetch = "SELECT * FROM learning_institutions WHERE school_level = 'college' AND status = 'subscribed' AND institution = 'public'";
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                $sql_fetch = "SELECT * FROM learning_institutions WHERE school_level = 'university' AND status = 'subscribed' AND institution = 'public'";
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                $sql_fetch = "SELECT * FROM learning_institutions WHERE school_level = 'others' AND status = 'subscribed' AND institution = 'public'";
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                $sql_fetch = "SELECT * FROM learning_institutions WHERE school_level = 'kindergarten' AND institution = 'public' AND status = 'not subscribed'";
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                $sql_fetch = "SELECT * FROM learning_institutions WHERE school_level = 'Primary' AND institution = 'public' AND status = 'not subscribed'";
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                $sql_fetch = "SELECT * FROM learning_institutions WHERE school_level = 'Secondary' AND institution = 'public' AND status = 'not subscribed'";
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                $sql_fetch = "SELECT * FROM learning_institutions WHERE school_level = 'College' AND institution = 'public' AND status = 'not subscribed'";
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                $sql_fetch = "SELECT * FROM learning_institutions WHERE school_level = 'University' AND institution = 'public' AND status = 'not subscribed'";
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                $sql_fetch = "SELECT * FROM learning_institutions WHERE school_level = 'Others' AND institution = 'public' AND status = 'not subscribed'";
    ...
    <div class="form-popup" id="myForm0">
        <form method="post" action="Panel?oneline=public_institutions" class="form-container" enctype="multipart/form-data">
    ...
    <div class="form-popup" id="myFormNon">
        <form method="post" action="Panel?oneline=public_institutions" class="form-container" enctype="multipart/form-data">
          <h4>Non Subscribed [ Public Only ]</h4><hr>
