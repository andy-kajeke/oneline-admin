...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div style="background-color: #fff; width: 180px; padding: 5px">
            <img src="<?= base_url("assets/img/logo.png"); ?>" width='150' height='40px'>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="form-inline my-2 my-lg-0">
                ...
                <?php } else { ?>
                    <!-- User not Login -->
                    <a style="margin-right: 20px" href="<?= base_url('User/registration') ?>" class="btn btn-info my-2 my-sm-0">Register</a> &nbsp;
